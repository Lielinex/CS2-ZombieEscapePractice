...
public class CPanoramaVote
{
    ...
    /// <param name="handler">Called when a menu action is completed.</param>
    /// <returns>True if the vote was successfully started, otherwise false.</returns>
    public bool SendYesNoVoteToAll(float flDuration, int iCaller, string sVoteTitle, string sDetailStr, YesNoVoteResult resultCallback, YesNoVoteHandler? handler = null, float duration = 0)
    {
